...
$result_project_information = mysqli_query($connection, $query_project_information);
...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
    ...
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
                <table class="border-collapse border border-gray-400">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result_project_information)) {
                            echo "<tr>";
                            echo "<td>" . $row['projectName'] . "</td>";
                            echo "<td>" . $row['batchNo'] . "</td>";
                            echo "<td>" . $row['projectLeader'] . "</td>";
                            echo "<td>" . $row['projectMember1'] . "</td>";
                            echo "<td>" . $row['projectMember2'] . "</td>";
                            echo "<td>" . $row['projectMember3'] . "</td>";
        ...
        <div>
            <h2 class="text-xl font-semibold mb-4">Status of 4 Stages</h2>
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
                <table class="border-collapse border border-gray-400">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo $stage1_status; ?></td>
                            <td><?php echo $stage2_status; ?></td>
                            <td><?php echo $stage3_status; ?></td>
                            <td><?php echo $stage4_status; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
