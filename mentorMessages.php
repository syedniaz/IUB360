...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkStudentQuery = "SELECT user_id FROM users WHERE email = '$studentEmail' AND user_type = 'student'";
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
            ...
            <div class="flex items-center justify-center h-fit mb-4 rounded bg-gray-50 ">
                    <form class="space-y-4 md:space-y-6 p-2" action="" method="post">
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Enter Student Email</label>
